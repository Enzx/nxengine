...
window::glfw_window::glfw_window(const int width, const int height, std::string& title) : interface_window(width, height, title)
{
...
void window::glfw_window::update()
{
    ...
    {
     events->publish(events::window_close{});
    }
}
