project "glfw"
	...
	files
	{
		"src/internal.h", "src/mappings.h", "src/glfw_config.h", "include/GLFW/glfw3.h", "include/GLFW/glfw3native.h",
	...
	filter "system:windows"
		...
		files
		{
			"src/win32_*.c", "src/win32_*.h", "src/wgl_context.c", "src/egl_context.c", "src/osmesa_context.c"
		}
